...
\subsection{Compromesso bias--varianza}
...
\subsection{Test di Fisher}
\begin{definition}[Ipotesi nulla, $H_0$] L'ipotesi nulla è l'ipotesi di cui si vuole verificare la validità tramite le osservazioni di una variabile casuale, $X$.
\end{definition}
...
\begin{example}[Progettazione di un esperimento]
\end{example}
...
\begin{example}[Test medico per malattie]
\end{example}
